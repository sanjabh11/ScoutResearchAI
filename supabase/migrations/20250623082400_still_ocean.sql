...
-- Create research_papers table first (no dependencies)
...
-- Enable Row Level Security on research_papers
...
-- Create summaries table (depends on research_papers)
...
-- Create similar_papers table (depends on research_papers)
...
-- Enable Row Level Security on similar_papers
...
-- Create generated_code table (depends on research_papers)
...
-- Enable Row Level Security on generated_code
...
-- Create visualizations table (depends on research_papers)
...
-- Enable Row Level Security on visualizations
