/*
  # Safe Database Migration for ScoutResearchAI

  1. New Tables
    - `research_papers` - Store uploaded research papers with analysis
    - `summaries` - Age-appropriate summaries of papers
    - `similar_papers` - Similar paper recommendations
  ...
  2. Security
    ...
    - Safely handle existing policies by dropping and recreating
